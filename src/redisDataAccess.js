...
/* There are currently three modules that use data access methods:
* -- domUtils
* -- simpleSearchEventHandlers
* -- exploreSearchEventHandlers
* To switch between data sources, change the data access imports
